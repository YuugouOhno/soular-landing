        ...
        <div className="wrap">
          ...
          <div className="domain ru">
            ...
            <div className="svc-grid">
              <div className="tile"><div className="t-no">01 / Medical HRMS</div><h4>医療特化型HRMS<br />メディマネージャー / デンタルマネージャー</h4><div className="cc">組織の定期健診と、明日使える処方箋</div><p>「ケースクエスチョン」で深層心理を可視化し、「明日Aさんにこう声をかけて」という具体的な行動指示を自動生成。院長とスタッフの相性診断に基づく適材適所で、離職を防ぎ、組織の定着を支えます。</p><div className="feat"><span>深層心理の可視化</span><span>行動指示の自動生成</span><span>相性診断</span></div></div>
              <div className="tile"><div className="t-no">02 / AI Concierge</div><h4>まごころAIチャット</h4><div className="cc">24時間働くデジタル受付</div><p>HPに常駐し定型質問へ即答し、現場の電話対応を軽減。夜間や休診日の問い合わせの取りこぼしを防ぎ、機会損失を抑制。患者の「本当のニーズ（検索キーワード）」を可視化し、広告費の無駄を抑えます。</p><div className="feat"><span>24時間対応</span><span>ニーズ可視化</span></div></div>
