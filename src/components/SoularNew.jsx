...
export default function SoularNew() {
        ...
        <div className="wrap">
          ...
          <div className="domain ru">
            ...
            <div className="svc-grid">
              <div className="tile"><div className="t-no">01 / Medical HRMS</div><h4>医療特化型HRMS<br />メディマネージャー / デンタルマネージャー</h4><div className="cc">組織の定期健診と、明日使える処方箋</div><p>「ケースクエスチョン」で深層心理を可視化し、「明日Aさんにこう声をかけて」という具体的な行動指示を自動生成。院長とスタッフの相性診断に基づく適材適所で、退職による月間85万円の損失リスクを防ぎます。</p><div className="feat"><span>深層心理の可視化</span><span>行動指示の自動生成</span><span>相性診断</span><span>¥85万 損失防止</span></div></div>
              <div className="tile"><div className="t-no">02 / AI Concierge</div><h4>まごころAIチャット</h4><div className="cc">24時間働くデジタル受付</div><p>HPに常駐し定型質問に即答、現場の電話件数を30〜50%削減。夜間や休診日の問い合わせの取りこぼしをゼロにし、機会損失を防止。患者の「本当のニーズ（検索キーワード）」を可視化し、広告費の漏れを塞ぎます。</p><div className="feat"><span>電話30〜50%削減</span><span>取りこぼしゼロ</span><span>ニーズ可視化</span></div></div>
              <div className="tile"><div className="t-no">03 / Official LINE</div><h4>LINEメイド</h4><div className="cc">月給1.5万円の電子お手伝いさん</div><p>予約・リマインド・リコール（定期検診案内）・デジタル診察券をLINEで全自動化。【独自】スタッフ専用メニューでの出退勤・シフト管理・業務日報を完結。【独自】訪問歯科の請求書を訪問先から直接ご家族のLINEへ送信。</p><div className="feat"><span>予約/リコール自動化</span><span>シフト・日報</span><span>請求書送信</span></div><a className="more" href="https://linemade.link/lp" target="_blank" rel="noreferrer">VIEW DETAIL →</a></div>
            </div>
          </div>
